package com.corptia.bringero.Utils.stickyheader.stickyView;
...
public class StickHeaderItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public StickHeaderItemDecoration(@NonNull StickyHeaderInterface listener , int space) {
        mListener = listener;
        this.space = space;
    }
...
//        View currentHeader = getHeaderViewForItem(position, parent);
//        fixLayoutSize(parent, currentHeader);
//        int contactPoint = currentHeader.getBottom();
//        View childInContact = getChildInContact(parent, contactPoint, position);
